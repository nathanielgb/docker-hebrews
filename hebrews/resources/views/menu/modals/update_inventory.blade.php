    ...
    <div class="relative w-auto pointer-events-none modal-dialog modal-dialog-centered">
        <div
            ...
            <div
                ...
                >
                <h5 class="text-xl font-medium leading-normal text-gray-800" id="updateInventoryModalLabel">
                    Update Inventory
                </h5>
                <button type="button"
            ...
            <div class="relative p-4 modal-body">
                <form id="update-inventory-form" action="{{ route('menu.update_inventory') }}" method="post">
                    @csrf

...
<div class="fixed top-0 left-0 hidden w-full h-full overflow-x-hidden overflow-y-auto bg-black bg-opacity-50 outline-none modal fade"
    ...
    tabindex="-1"
    aria-labelledby="updateBranchModalLabel"
    aria-hidden="true"
    >
    <div class="relative w-auto pointer-events-none modal-dialog modal-dialog-centered">
        <div
            ...
            <div
                ...
                >
                <h5 class="text-xl font-medium leading-normal text-gray-800" id="updateBranchModalLabel">
                    Update Branch
                </h5>
                <button type="button"
            ...
            <div class="relative p-4 modal-body">
                <form id="update-form" method="post" action="{{ route('users.branch.update') }}">
                    @csrf

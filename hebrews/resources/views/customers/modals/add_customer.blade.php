            ...
            <div class="relative p-4 modal-body">
                <form id="add-account-form" action="{{ route('customers.store') }}" method="post" autocomplete="off">
                    ...
                    <label class="block mb-4 text-sm">
                        ...
                        <input class="block w-full mt-1 text-sm focus:border-purple-400 focus:outline-none focus:shadow-outline-purple form-input" name="email" type="email" placeholder="Enter email">
                    </label>
                    <label class="block mb-4 text-sm">
                        <span class="text-gray-700">Contact Number</span>
                        <input class="block w-full mt-1 text-sm focus:border-purple-400 focus:outline-none focus:shadow-outline-purple form-input" name="contact_number" type="text" placeholder="Enter contact number">
                    </label>
                    <label class="block mb-4 text-sm">
                        <span class="text-gray-700">Address</span>
                        <input class="block w-full mt-1 text-sm focus:border-purple-400 focus:outline-none focus:shadow-outline-purple form-input" name="address" type="text" placeholder="Enter address">
                    </label>
                </form>
            </div>
            <div

        ...
        <div class="p-4 bg-white rounded-lg shadow-xs">
            <form id="pay_form" action="{{ route('order.pay',$order->order_id) }}" method="post" autocomplete="off">
                ...
                <label class="block mb-4 text-sm">
                    ...
                    <select class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:outline-none focus:shadow-outline-gray dark:focus:shadow-outline-gray" name="account" required>
                ...
                <label class="block mb-4 text-sm">
                    ...
                    <input id="given-input" name="input_amt" min="0.01" step=".01" class="block w-full mt-1 text-sm focus:outline-none focus:shadow-outline-gray form-input" type="number" placeholder="Enter Amount received">
                </label>

            ...
            <div class="relative p-4 modal-body">
                <form id="update-discount-form" action="{{ route('discount.update') }}" method="post">
                    ...
                    <label class="block mb-4 text-sm">
                        ...
                        <input class="block w-full mt-1 text-sm focus:outline-none focus:shadow-outline-gray form-input" name="name" type="text" placeholder="Enter name" :value="$store.discount.updateData.name">
                    </label>
                    <label class="block mb-4 text-sm">
                    ...
                    <label class="block mb-4 text-sm">
                        ...
                        <input class="block w-full mt-1 text-sm focus:outline-none focus:shadow-outline-gray form-input" name="amount" type="number" min="0" step="0.01" placeholder="Enter amount" :value="$store.discount.updateData.amount">
                    </label>

<div
    ...
    id="serveOrderItemModal"
    tabindex="-1"
    aria-labelledby="serveOrderItemModalTitle"
    aria-modal="true"
    role="dialog"
    >
    <div class="relative w-auto pointer-events-none modal-dialog modal-dialog-centered">
        ...
        <div class="relative p-4 modal-body">
            <form id="serve-ord-item-form" action="{{ route('dispatch.order.serve') }}" method="post">
                @csrf
                <label class="block mb-4 text-sm">
                    <p>Are you sure that the <strong x-text="serveKitchenItemName"></strong> is ready to serve?</p>
                    <input name="id" type="hidden" :value="serveKitchenItemId">
                </label>
            </form>
        </div>
        <div

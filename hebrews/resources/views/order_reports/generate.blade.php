        ...
        <div class="p-4 bg-white rounded-lg shadow-xs">
            <form action="{{ route('orders.report.generate') }}" method="get" autocomplete="off">
                ...
                <label class="block mb-4 text-sm">
                    ...
                    <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-green-400 focus:outline-none focus:shadow-outline-green dark:text-gray-300 dark:focus:shadow-outline-gray form-input" name="order_id" type="text" placeholder="Enter order number/s">
                ...
                <label class="block mb-4 text-sm">
                    ...
                    <select class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-green-400 focus:outline-none focus:shadow-outline-green dark:focus:shadow-outline-gray" name="status">
                ...
                <label class="block mb-4 text-sm">
                    ...
                    <select class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-green-400 focus:outline-none focus:shadow-outline-green dark:focus:shadow-outline-gray" name="servername">
                ...
                <label class="block mb-4 text-sm">
                    ...
                    <select class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-green-400 focus:outline-none focus:shadow-outline-green dark:focus:shadow-outline-gray" name="customer_name">

<div
    ...
    id="doneOrderItemModal"
    tabindex="-1"
    aria-labelledby="doneOrderItemModalTitle"
    aria-modal="true"
    role="dialog"
    >
    <div class="relative w-auto pointer-events-none modal-dialog modal-dialog-centered">
        ...
        <div class="relative p-4 modal-body">
            <form id="complete-ord-item-form" action="{{ route('kitchen.order.done') }}" method="post">
                @csrf
                <label class="block mb-4 text-sm">
                    <p>Are you sure that the <strong x-text="completeKitchenItemName"></strong> is ready to serve?</p>
                    <input name="id" type="hidden" :value="completeKitchenItemId">
                </label>
            </form>
        </div>
        <div
